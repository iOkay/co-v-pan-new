...
- (UIImage *)roundedCornerImage:(NSInteger)cornerRadius borderSize:(NSInteger)borderSize;
@end
...
will be added around the edges of the thumbnail. 
(Adding a transparent border of at least one pixel in size has the side-effect 
       ...
       interpolationQuality : (CGInterpolationQuality)quality
{
    ...
    return [transparentBorderImage roundedCornerImage: cornerRadius
