...
//for ASWebView
#define KNoWeb                       localeString(@"noweb")
...
//for ASZip
#define KEntriesinthezipfile         localeString(@"entries in the zip file")
...
#define kSharebutton localeString(@"emailbutton")
...
#define kvSharebutton localeString(@"vemailbutton")
...
#define kDownLoadTitle localeString(@"Transfer")
