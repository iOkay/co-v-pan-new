...
@interface ASDeclare : NSObject {
    ...
    NSString *vsharebutton;
    NSString *vmovebutton;
    
    //for download view controller
    NSString *downloadTitle;
    
    //for ZBar Reader View
    NSString *zbarResult;
}
...
@property (nonatomic, readonly) NSString *noweb;
...
@property (nonatomic, readonly) NSString *entries;
...
@property (nonatomic, readonly) NSString *sharebutton;
...
@property (nonatomic, readonly) NSString *vsharebutton;
@property (nonatomic, readonly) NSString *vmovebutton;

@property (nonatomic, readonly) NSString *downloadTitle;

@property (nonatomic, readonly) NSString *zbarResult;
